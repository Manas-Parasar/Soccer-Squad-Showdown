...
public class PlayerManager {
    ...
    private void initializePlayers() {
        ...
        allDefenders.put("Kounde", new DefenderPlayer("Jules Kounde", "Right back", 93, 91, 92, 94, 95));

        // Goalkeepers
        allGoalkeepers.put("Neuer", new GoalkeeperPlayer("Manuel Neuer", "Goalkeeper", 95, 94, 94, 94, 97));
        allGoalkeepers.put("Buffon", new GoalkeeperPlayer("Gianluigi Buffon", "Goalkeeper", 94, 92, 94, 93, 89));
        allGoalkeepers.put("Casillas", new GoalkeeperPlayer("Iker Casillas", "Goalkeeper", 93, 93, 93, 92, 90));
        allGoalkeepers.put("Ter-Stegen", new GoalkeeperPlayer("Marc Andre Ter-Stegen", "Goalkeeper", 93, 91, 92, 93, 95));
    }
