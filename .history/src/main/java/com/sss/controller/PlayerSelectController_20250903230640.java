...
public class PlayerSelectController {
    ...
    @FXML private ListView<ApiClient.PlayerSearchResult> searchResultsList;
    ...
    public void initialize() {
        ...
        searchResultsList.setCellFactory(lv -> new ListCell<>() {
            @Override protected void updateItem(ApiClient.PlayerSearchResult r, boolean empty) {
                ...
                try {
                    ...
                    iv.setImage(new Image(getClass().getResourceAsStream("/images/default.png")));
                }
